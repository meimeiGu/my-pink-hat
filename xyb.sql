...
CREATE TABLE `xyb_gbgoods` (
  ...
  `gbgoods_name` varchar(20) NULL COMMENT '团购商品名称',  
  `gbgoods_originprice` decimal(10,2)  NULL  COMMENT '团购商品原价', 
  `gbgoods_price` decimal(10,2) NULL COMMENT '团购商品价格',
  `gbgoods_gbprice` decimal(10,2) NULL COMMENT '团购商品团购价',
  `gbgoods_pic` varchar(50) NULL COMMENT '轮播图片',
  `gbgoods_pnum` tinyint(4) NULL COMMENT '规定团购人数',
  `gbgoods_tnum` int(11) NULL COMMENT '已团人数',
  `gbgoods_num` int(30) NULL COMMENT '数量',
  `gbgoods_details` mediumtext NULL COMMENT '商品详情',
  `gbgoods_picdetails` mediumtext NULL COMMENT '商品图片详情',  
  PRIMARY KEY (`gbgoods_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `xyb_gbrull`;
CREATE TABLE `xyb_gbrull` ( 
  `gbrull_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '服务编号',
  `gbrull_title` varchar(30) NOT NULL COMMENT '服务标题',
  `gbrull_comment` varchar(50) NOT NULL COMMENT '服务解释',
...
CREATE TABLE `xyb_gborder` (
  ...
  `order_time` datetime DEFAULT NULL COMMENT '总订单时间',
  `order_price` decimal(8,1) DEFAULT NULL COMMENT '订单总价格',
  `order_phone` varchar(12) DEFAULT NULL COMMENT '订单联系人号码',
...
CREATE TABLE `xyb_gbsingleorder` (
  `gbsingleorder_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '团购商品单条商品编号',
  ...
  `gbgoodsPrice` decimal(5,1) DEFAULT NULL COMMENT '单条商品价格',
